...
const Education = ({ setEducationItems, Subcategory }) => {
  ...
  const subcategoryFields = {
    "Libraries": [{ name: "name", type: "text", placeholder: "name" }],
    "Bookstores": [{ name: "name", type: "text", placeholder: "name" }],
    "Education Centers": [{ name: "name", type: "text", placeholder: "name" }],
    "Art Schools":[{ name: "name", type: "text", placeholder: "name" }],
    "Cooking Schools":[{ name: "name", type: "text", placeholder: "name" }],
    "Language Schools" :[{ name: "name", type: "text", placeholder: "name" }],
    "Workshops & Classes" :[{ name: "name", type: "text", placeholder: "name" }],
    "reserch Institution": [{ name: "name", type: "text", placeholder: "name" }],
  };

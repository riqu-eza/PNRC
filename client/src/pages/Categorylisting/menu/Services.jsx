...
const Servicesmenu = ({ subcategories, listingemail, listingname, listingaddress }) => {
  ...
  const filteredMenuItems = selectedSubcategory
    ? subcategories.find((subcat) => subcat.subcategory === selectedSubcategory)
        ?.ServiceItems || []
    : subcategories.flatMap((subcat) => subcat.ServiceItems); // Show all if no subcategory is selected

...
const Shoppingmodal = ({ event, onClose, listingemail, listingname, listingaddress }) => {
  ...
  switch (event.subcategory) {
      ...
      return (
        <>
          <p className="text-lg mb-2">
            <strong>Number of Stores:</strong> {event.numberOfStores}
          </p>
          <p className="text-lg mb-2">
            <strong>Parking Available:</strong> {event.parkingAvailability ? "Yes" : "No"}
          </p>
          <p className="text-lg mb-2">
            <strong>Food Court:</strong> {event.foodCourt ? "Available" : "Not Available"}
          </p>
          <p className="text-lg mb-2">
            <strong>Entertainment Options:</strong> {event.entertainmentOptions}
          </p>
          <p className="text-lg mb-2">
            <strong>Security Services:</strong> {event.securityServices ? "Available" : "Not Available"}
          </p>
          <p className="text-lg mb-2">
    ...
    case "Markets":
      return (
        <>
          <p className="text-lg mb-2">
            <strong>Market Type:</strong> {event.marketType}
          </p>
          <p className="text-lg mb-2">
            <strong>Operating Days:</strong> {event.operatingDays}
          </p>
          <p className="text-lg mb-2">
            <strong>Entrance Fee:</strong> ${event.entranceFee}
          </p>
        </>
      );
    case "Antique Stores":
      return (
        <>
          ...
          <p className="text-lg mb-2">
            <strong>Year Established:</strong> {event.yearEstablished}
          </p>
          <p className="text-lg mb-2">
            <strong>Authenticity Guarantee:</strong> {event.authenticityGuarantee ? "Yes" : "No"}
          </p>
        </>
      );
    case "Souvenir Shops":
      return (
        <>
          <p className="text-lg mb-2">
            <strong>Items Available:</strong> {event.itemsAvailable}
          </p>
          <p className="text-lg mb-2">
            <strong>Pricing Range:</strong> ${event.pricingRange}
          </p>
        </>
      );
    case "Department stores":
      return (
        <p className="text-lg mb-2">
          <strong>Department Store:</strong> Wide variety of products available
        </p>
      );
    case "Outlet Stores":
      return (
        <>
          <p className="text-lg mb-2">
            <strong>Brands Available:</strong> {event.brandsAvailable}
          </p>
          <p className="text-lg mb-2">
            <strong>Discount Range:</strong> {event.discountRange}
          </p>
        </>
      );
    case "Speciality Stores":
      return (
        <>
          <p className="text-lg mb-2">
            <strong>Speciality:</strong> {event.speciality}
          </p>
          <p className="text-lg mb-2">
            <strong>Unique Services:</strong> {event.uniqueServices}
          </p>
        </>
      );
    default:

...
export default function About() {
  ...
  return (
    <>
      <div className="about">
        <p className="text-white-200 text-center text-xl">simply Amazing place</p>
      ...
      <div class="flex justify-evenly mt-28 m-16">
        <div class="flex flex-col items-center">
          <div class="icon1  "></div>
          <div class="text-2xl font-bold text-3xl">001</div>
        ...
        <div class="flex flex-col items-center ">
          <div class="icon3"></div>
          <div class="text-2xl font-bold text-3xl">005</div>
          <div class="text-base text-xl">Resort Cities</div>
        </div>
        <div class="flex flex-col items-center">
          <div class="icon4"></div>
          <div class="text-2xl font-bold text-3xl">000</div>

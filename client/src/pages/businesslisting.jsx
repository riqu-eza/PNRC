...
const BusinessDetails = () => {
  ...
  return (
    <div className="text-center p-4 h-screen overflow-auto">
      ...
      <div className="flex flex-col md:flex-row justify-center gap-4 md:gap-8">
        <div
          className="key-products flex flex-col border-r border-gray-300 mb-4 md:mb-0"
        ...
        >
          ...
          {keyProducts.map((productGroup, index) => (
            <button
              key={index}
              className={`p-2 mb-2 border rounded text-left ${
        ...
        <div
          ...
          style={{ width: "100%", padding: "1rem", maxHeight: "80vh" }}
        >

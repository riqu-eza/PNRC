...
const AccommodationSearch = ({ listings }) => {
  ...
  return (
    <div className="flex flex-col lg:flex-row mx-4 lg:mx-28 mt-2 bg-gray-100 border h-screen">
    {/* Left Filter Section */}
    <div className="w-full lg:w-1/3 p-3 space-y-6 m-1 overflow-y-auto overflow-x-hidden">
      {/* Google Map */}
      <div className="h-72 mb-4 shadow-lg rounded">
        <GoogleMapReact
      ...
      <div className="p-1">
        ...
        <button
          className={`block w-full sm:w-72 text-xl m-1 p-2 rounded-md cursor-pointer 
        ...
        <div className="space-y-2 p-1 overflow-y-auto max-h-40">
          {listings
            ...
            .map((subcat) => (
              ...
              >
                {subcat.subcategory} ({getUniqueSubcategoryCount(subcat.subcategory)})
              </button>
            ))}
        </div>
      </div>
      ...
      {/* Room Type Filter */}
      <div className="p-1">
        <h4 className="font-bold text-center text-lg mb-2">Room Type</h4>
        <button
          className={`block w-full text-left px-4 py-2 rounded-md cursor-pointer 
    ...
    <div className="w-full lg:w-2/3 p-2 space-y-4 m-1 overflow-y-auto">
      <div>
